...
from customized_gpt2_all import CustomizedGPT2LMHeadModel
...
def customized_greedy_decoding(batch):
    ...
    for t in range(seq_len-1):
        prefix = tokenizer.decode(input_ids[:, : t + 1][0], skip_special_tokens=True)
    ...
    for t in range(MAX_NEW_LENGTH):
        ...
        prefix = tokenizer.decode(res[0], skip_special_tokens=True)
